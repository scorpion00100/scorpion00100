...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 27 19:22:48 2021
...
def move():
    ...
    if direction  == 'gauche':
        ...
        if Serpent[0][1] > 493:
            Serpent[0][1] = 0
    can.create_oval(Serpent[0][0], Serpent[0][1], Serpent[0][0]+10, Serpent[0][1]+10,outline='green', fill='white')
    test()
    test()
...
b2 = Button(fen, text='Quitter', command=fen.destroy, bg='black' , fg='red')
b2.pack(side=RIGHT, padx=5, pady =5)

tex1 = Label(fen, text="Cliquez sur 'New Game' pour commencer le jeu.", bg='black' , fg='blue')
